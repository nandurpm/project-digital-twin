...
```bash
git clone https://github.com/nandurpm/project-digital-twin.git
cd project-digital-twin
pnpm install
```
...
**Live URL:** [https://project-digital-twin.onrender.com](https://project-digital-twin.onrender.com)
...
| [`src/`](src/README.md) | Contains the production implementation of Project Digital Twin: command handling, domain rules, storage, reports, and local serving as applicable. |
| [`tests/`](tests/README.md) | Contains automated regression tests for Project Digital Twin's public behavior and important safety constraints. |
...
- [`src/README.md`](src/README.md) — Contains the production implementation of Project Digital Twin: command handling, domain rules, storage, reports, and local serving as applicable.
- [`tests/README.md`](tests/README.md) — Contains automated regression tests for Project Digital Twin's public behavior and important safety constraints.
